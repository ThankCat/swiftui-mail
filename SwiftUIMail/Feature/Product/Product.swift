...
struct Product: Identifiable, Codable, Hashable {
    ...
    init(id: String, number: String, title: String, icon: String, icons: [String] = [], video: String? = nil, keyword: String? = nil, category1Id: String? = nil, category2Id: String? = nil, category3Id: String? = nil, originPrice: Int = 0, price: Int = 0, memberPrice: Int = 0, highlight: String? = nil, detail: String? = nil, sale: UInt8 = 1, delete: UInt8 = 0, hot: UInt8 = 0, news: UInt8 = 0, recommend: UInt8 = 0, commentsRate: Float = 0.0, commentsCount: Int64 = 0, salesCount: Int64 = 0, stocksCount: Int64 = 0, score: Float = 0.0, stocks: [Stock]? = nil, specs: [Spec]? = nil) {
        self.id = id
        self.number = number
        self.title = title
        self.icon = icon
    ...
    static let PREVIEW_DATUM = [
        ...
        Product(
            ...
            number: "P21",
            title: "傻厨电煎锅多功能家用不粘锅电饼铛一体锅烙饼锅电烤锅烤肉电烤锅",
            icon: "https://img.youpin.mi-img.com/shopmain/d14a64c4e25279e3e4abac68e51dc63b.png@base@tag=imgScale&h=342&w=342",
            icons: [
                "mall/products/b20.jpg",
                "mall/products/b21.jpg"
            ],
...
struct Stock: Identifiable,Hashable,Codable {
    ...
    static let PREVIEW_STOCKS: [Stock] = [
        Stock(id: "1", ids: "201211", number: "S201211", title: "岩石青 8GB+256GB", icon: nil, price: 1, originPrice: 2, status: 10, stock: 456, weight: 456.0),
        Stock(id: "2", ids: "201212", number: "S201212", title: "岩石青 12GB+256GB", icon: "https://rs.ixuea.com/quick/mall/products/s20.png", price: 2, originPrice: 3, status: 10, stock: 456, weight: 456.0),
        Stock(id: "3", ids: "202211", number: "S202211", title: "黑色 8GB+256GB", icon: "https://rs.ixuea.com/quick/mall/products/s21.png", price: 1, originPrice: 3, status: 10, stock: 60, weight: 12.0)
    ]
}
